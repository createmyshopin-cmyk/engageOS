        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="text-xs text-[#6B7280] font-medium">
              Templates, automation, coupon delivery and analytics for your connected WATI gateway
              (API v3).
            </p>
          </div>
          <Link
            href="/m/integrations/wati"
            className="ml-auto inline-flex items-center gap-1.5 rounded-xl border border-[#E5E7EB] bg-white px-3 py-2 text-xs font-bold text-[#6B7280] hover:text-[#111827] hover:border-[#D1D5DB] transition-colors"
          >
