...
import { getMediaUrl, downloadMedia } from '@/lib/wacrm/whatsapp/meta-api'
import { normalizePhone } from '@/lib/wacrm/whatsapp/phone-utils'
import { findExistingContact, isUniqueViolation } from '@/lib/wacrm/contacts/dedupe'
import { verifyMetaWebhookSignature } from '@/lib/wacrm/whatsapp/webhook-signature'
import { runAutomationsForTrigger } from '@/lib/wacrm/automations/engine'
import { dispatchInboundToFlows } from '@/lib/wacrm/flows/engine'
import { dispatchInboundToAiReply } from '@/lib/wacrm/ai/auto-reply'
import { dispatchWebhookEvent } from '@/lib/wacrm/webhooks/deliver'
import {
  handleTemplateWebhookChange,
  isTemplateWebhookField,
} from '@/lib/wacrm/whatsapp/template-webhook'
