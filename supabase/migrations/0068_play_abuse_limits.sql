-- =============================================================
-- 0068_play_abuse_limits.sql
-- Strengthen customer play URL abuse limits: IP, per-campaign, device.
-- =============================================================
...
-- record_scan — add global per-IP flood guard for page refresh / scan DDoS.
...
begin
  ...
  if not check_rate_limit('scanip:' || p_ip, 120) then
    return;
  end if;
